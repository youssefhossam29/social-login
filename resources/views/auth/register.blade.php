<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-2 flex justify-center">
            <a href="{{ route('social.redirect', ['provider' => 'github']) }}" class="flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full transition duration-150 ease-in-out">
                <svg class="h-5 w-5 fill-current text-gray-800" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- X Register Button -->
        <div class="mt-2 flex justify-center">
            <a href="{{ route('social.redirect', ['provider' => 'x']) }}" class="flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full transition duration-150 ease-in-out">
                <svg class="h-4 w-4 fill-current text-gray-800" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mt-2 flex justify-center">
            <a href="{{ route('social.redirect', ['provider' => 'discord']) }}" class="flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full transition duration-150 ease-in-out">
